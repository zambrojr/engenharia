        ...
        <div class="container-fluid">
          <div class="animated fadeIn">
            <div class="card-columns cols-2">
              <div class="card">
                <div class="card-header">Lagoa dos Cisnes
              ...
              <div class="card">
                <div class="card-header">Lagoa dos Patos
                  <div class="card-header-actions">
                    <a class="card-header-action" href="http://www.chartjs.org" target="_blank">
                      <small class="text-muted">docs</small>
                    </a>
...
import painelLayerImg from './OpenLayer/painel_image.vue';
...
export default {
    ...
    components: {
      ...
      'painel-layer-img' :painelLayerImg,
    },     
